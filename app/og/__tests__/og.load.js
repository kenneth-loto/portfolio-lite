...
// Reuse canonical base URL — same as app/sitemap.ts
const BASE_URL = "https://www.kennethloto.dev";

// Custom metrics to track og-specific performance
...
export const options = {
  scenarios: {
    og_load: {
      ...
      startVUs: 0,
      stages: [
        { duration: "10s", target: 5 }, // warm up — slowly introduce VUs
        { duration: "20s", target: 20 }, // ramp up — increase to peak load
        { duration: "20s", target: 20 }, // hold — sustain peak load
        { duration: "10s", target: 0 }, // ramp down — graceful cool down
      ],
    },
  },
};
...
export default function () {
  ...
  // Explicit variable name instead of res
