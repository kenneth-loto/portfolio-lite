...
export async function GET() {
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        <div style={{ display: "flex", fontSize: 18 }}>
          ...
          <span style={{ color: colors.mutedForeground }}>&nbsp;</span>
          <span style={{ color: colors.path }}>/c/Next.js/portfolio-lite</span>
          <span style={{ color: colors.mutedForeground }}>&nbsp;</span>
    ...
    </div>,
    {
      ...
      fonts: [
        { name: "Geist Mono", data: fontRegular, style: "normal", weight: 400 },
        { name: "Geist Mono", data: fontMedium, style: "normal", weight: 500 },
      ],
    },
  );
}
